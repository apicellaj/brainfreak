...
public class GUI extends JFrame {
	...
	private void createAndShowGui() {
		...
		sizeButtonPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Frame Size",
		...
		sampleProgramsPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(),
